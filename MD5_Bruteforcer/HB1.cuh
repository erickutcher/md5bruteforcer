...
void RHL06B01()
{
	register unsigned int in00, a, b, c, d, ra, rb, rc, rd, i;	// Don't initialize.

	// Pregenerated input. Looks like 0xFFFFFF00. The last byte is set in the loop below.
	register unsigned int in00a = gd_input_chunk[ blockIdx.x * blockDim.x + threadIdx.x ];
	...
	register unsigned short css = gd_character_set_size;

	register unsigned int in01 = gd_input_chunk2[ 0 ];

	// The last two bytes of the the input are used as a key into the reversed_hash_values buffer.
	register unsigned int tmp = ( in01 & 0x0000FF00 ) >> 8;
	register unsigned int tmp2 = in01 & 0x000000FF;

	// Set the last two bytes to their character representation.
	in01 = 0x00800000 | gd_character_set[ tmp ] << 8 | gd_character_set[ tmp2 ];

	// The gd_reversed_hash_values offest.
	tmp = ( tmp * css + tmp2 ) << 2;	// Shift by 2 to multiply by 4.

	// These are prereversed round 4 values. Reversed from steps 64 to 49.
	register unsigned int tra = gd_reversed_hash_values[ tmp ];
	register unsigned int trb = gd_reversed_hash_values[ tmp + 1 ];
	register unsigned int trc = gd_reversed_hash_values[ tmp + 2 ];
	register unsigned int trd = gd_reversed_hash_values[ tmp + 3 ];
...
void HL09B01()
{
	...
	register unsigned int in01 = gd_input_chunk2[ 0 ];
	register unsigned int in02 = gd_input_chunk2[ 1 ];
...
void HL13B01()
{
	...
	register unsigned int in01 = gd_input_chunk2[ 0 ];
	register unsigned int in02 = gd_input_chunk2[ 1 ];
	register unsigned int in03 = gd_input_chunk2[ 2 ];
...
void HL17B01()
{
	...
	register unsigned int in02 = gd_input_chunk2[ 1 ];
	register unsigned int in03 = gd_input_chunk2[ 2 ];
	register unsigned int in04 = gd_input_chunk2[ 3 ];
...
void HL21B01()
{
	...
	register unsigned int in03 = gd_input_chunk2[ 2 ];
	register unsigned int in04 = gd_input_chunk2[ 3 ];
	register unsigned int in05 = gd_input_chunk2[ 4 ];
...
void HL25B01()
{
	...
	register unsigned int in04 = gd_input_chunk2[ 3 ];
	register unsigned int in05 = gd_input_chunk2[ 4 ];
	register unsigned int in06 = gd_input_chunk2[ 5 ];
...
void HL29B01()
{
	...
	register unsigned int in05 = gd_input_chunk2[ 4 ];
	register unsigned int in06 = gd_input_chunk2[ 5 ];
	register unsigned int in07 = gd_input_chunk2[ 6 ];
...
void HL33B01()
{
	...
	register unsigned int in06 = gd_input_chunk2[ 5 ];
	register unsigned int in07 = gd_input_chunk2[ 6 ];
	register unsigned int in08 = gd_input_chunk2[ 7 ];
...
void HL37B01()
{
	...
	register unsigned int in07 = gd_input_chunk2[ 6 ];
	register unsigned int in08 = gd_input_chunk2[ 7 ];
	register unsigned int in09 = gd_input_chunk2[ 8 ];
...
void HL41B01()
{
	...
	register unsigned int in08 = gd_input_chunk2[ 7 ];
	register unsigned int in09 = gd_input_chunk2[ 8 ];
	register unsigned int in10 = gd_input_chunk2[ 9 ];
...
void HL45B01()
{
	...
	register unsigned int in09 = gd_input_chunk2[ 8 ];
	register unsigned int in10 = gd_input_chunk2[ 9 ];
	register unsigned int in11 = gd_input_chunk2[ 10 ];
...
void HL49B01()
{
	...
	register unsigned int in10 = gd_input_chunk2[ 9 ];
	register unsigned int in11 = gd_input_chunk2[ 10 ];
	register unsigned int in12 = gd_input_chunk2[ 11 ];
...
void HL53B01()
{
	...
	register unsigned int in11 = gd_input_chunk2[ 10 ];
	register unsigned int in12 = gd_input_chunk2[ 11 ];
	register unsigned int in13 = gd_input_chunk2[ 12 ];
