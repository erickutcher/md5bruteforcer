...
void HL01B03N()
{
	...
	register unsigned int in00a = gd_input_chunk[ ( blockIdx.x * blockDim.x + threadIdx.x ) * 3 ];
...
void HL05B03N()
{
	...
	register unsigned int *input = gd_input_chunk + ( blockIdx.x * blockDim.x + threadIdx.x ) * 3;
...
void HL09B03N()
{
	...
	register unsigned int in01 = input[ 1 ];
	register unsigned int in02 = input[ 2 ];
...
void HL13B03N()
{
	...
	register unsigned int in03 = gd_input_chunk2[ 0 ];
...
void HL17B03N()
{
	...
	register unsigned int in03 = gd_input_chunk2[ 0 ];
	register unsigned int in04 = gd_input_chunk2[ 1 ];
...
void HL21B03N()
{
	...
	register unsigned int in03 = gd_input_chunk2[ 0 ];
	register unsigned int in04 = gd_input_chunk2[ 1 ];
	register unsigned int in05 = gd_input_chunk2[ 2 ];
...
void HL25B03N()
{
	...
	register unsigned int in04 = gd_input_chunk2[ 1 ];
	register unsigned int in05 = gd_input_chunk2[ 2 ];
	register unsigned int in06 = gd_input_chunk2[ 3 ];
...
void HL29B03N()
{
	...
	register unsigned int in05 = gd_input_chunk2[ 2 ];
	register unsigned int in06 = gd_input_chunk2[ 3 ];
	register unsigned int in07 = gd_input_chunk2[ 4 ];
...
void HL33B03N()
{
	...
	register unsigned int in06 = gd_input_chunk2[ 3 ];
	register unsigned int in07 = gd_input_chunk2[ 4 ];
	register unsigned int in08 = gd_input_chunk2[ 5 ];
...
void HL37B03N()
{
	...
	register unsigned int in07 = gd_input_chunk2[ 4 ];
	register unsigned int in08 = gd_input_chunk2[ 5 ];
	register unsigned int in09 = gd_input_chunk2[ 6 ];
...
void HL41B03N()
{
	...
	register unsigned int in08 = gd_input_chunk2[ 5 ];
	register unsigned int in09 = gd_input_chunk2[ 6 ];
	register unsigned int in10 = gd_input_chunk2[ 7 ];
...
void HL45B03N()
{
	...
	register unsigned int in09 = gd_input_chunk2[ 6 ];
	register unsigned int in10 = gd_input_chunk2[ 7 ];
	register unsigned int in11 = gd_input_chunk2[ 8 ];
...
void HL49B03N()
{
	...
	register unsigned int in10 = gd_input_chunk2[ 7 ];
	register unsigned int in11 = gd_input_chunk2[ 8 ];
	register unsigned int in12 = gd_input_chunk2[ 9 ];
...
void HL53B03N()
{
	...
	register unsigned int in11 = gd_input_chunk2[ 8 ];
	register unsigned int in12 = gd_input_chunk2[ 9 ];
	register unsigned int in13 = gd_input_chunk2[ 10 ];
