...
void HL01B04N()
{
	...
	register unsigned int in00a = gd_input_chunk[ ( blockIdx.x * blockDim.x + threadIdx.x ) * 4 ];
...
void HL05B04N()
{
	...
	register unsigned int *input = gd_input_chunk + ( blockIdx.x * blockDim.x + threadIdx.x ) * 4;
...
void HL13B04N()
{
	...
	register unsigned int in01 = input[ 1 ];
	register unsigned int in02 = input[ 2 ];
	register unsigned int in03 = input[ 3 ];
...
void HL17B04N()
{
	...
	register unsigned int in04 = gd_input_chunk2[ 0 ];
...
void HL21B04N()
{
	...
	register unsigned int in04 = gd_input_chunk2[ 0 ];
	register unsigned int in05 = gd_input_chunk2[ 1 ];
...
void HL25B04N()
{
	...
	register unsigned int in04 = gd_input_chunk2[ 0 ];
	register unsigned int in05 = gd_input_chunk2[ 1 ];
	register unsigned int in06 = gd_input_chunk2[ 2 ];
...
void HL29B04N()
{
	...
	register unsigned int in05 = gd_input_chunk2[ 1 ];
	register unsigned int in06 = gd_input_chunk2[ 2 ];
	register unsigned int in07 = gd_input_chunk2[ 3 ];
...
void HL33B04N()
{
	...
	register unsigned int in06 = gd_input_chunk2[ 2 ];
	register unsigned int in07 = gd_input_chunk2[ 3 ];
	register unsigned int in08 = gd_input_chunk2[ 4 ];
...
void HL37B04N()
{
	...
	register unsigned int in07 = gd_input_chunk2[ 3 ];
	register unsigned int in08 = gd_input_chunk2[ 4 ];
	register unsigned int in09 = gd_input_chunk2[ 5 ];
...
void HL41B04N()
{
	...
	register unsigned int in08 = gd_input_chunk2[ 4 ];
	register unsigned int in09 = gd_input_chunk2[ 5 ];
	register unsigned int in10 = gd_input_chunk2[ 6 ];
...
void HL45B04N()
{
	...
	register unsigned int in09 = gd_input_chunk2[ 5 ];
	register unsigned int in10 = gd_input_chunk2[ 6 ];
	register unsigned int in11 = gd_input_chunk2[ 7 ];
...
void HL49B04N()
{
	...
	register unsigned int in10 = gd_input_chunk2[ 6 ];
	register unsigned int in11 = gd_input_chunk2[ 7 ];
	register unsigned int in12 = gd_input_chunk2[ 8 ];
...
void HL53B04N()
{
	...
	register unsigned int in11 = gd_input_chunk2[ 7 ];
	register unsigned int in12 = gd_input_chunk2[ 8 ];
	register unsigned int in13 = gd_input_chunk2[ 9 ];
