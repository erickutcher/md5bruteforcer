...
void HL01B06N()
{
	...
	register unsigned int in00a = gd_input_chunk[ ( blockIdx.x * blockDim.x + threadIdx.x ) * 6 ];
...
void HL05B06N()
{
	...
	register unsigned int *input = gd_input_chunk + ( blockIdx.x * blockDim.x + threadIdx.x ) * 6;
...
void HL21B06N()
{
	...
	register unsigned int in03 = input[ 3 ];
	register unsigned int in04 = input[ 4 ];
	register unsigned int in05 = input[ 5 ];
...
void HL25B06N()
{
	...
	register unsigned int in06 = gd_input_chunk2[ 0 ];
...
void HL29B06N()
{
	...
	register unsigned int in06 = gd_input_chunk2[ 0 ];
	register unsigned int in07 = gd_input_chunk2[ 1 ];
...
void HL33B06N()
{
	...
	register unsigned int in06 = gd_input_chunk2[ 0 ];
	register unsigned int in07 = gd_input_chunk2[ 1 ];
	register unsigned int in08 = gd_input_chunk2[ 2 ];
...
void HL37B06N()
{
	...
	register unsigned int in07 = gd_input_chunk2[ 1 ];
	register unsigned int in08 = gd_input_chunk2[ 2 ];
	register unsigned int in09 = gd_input_chunk2[ 3 ];
...
void HL41B06N()
{
	...
	register unsigned int in08 = gd_input_chunk2[ 2 ];
	register unsigned int in09 = gd_input_chunk2[ 3 ];
	register unsigned int in10 = gd_input_chunk2[ 4 ];
...
void HL45B06N()
{
	...
	register unsigned int in09 = gd_input_chunk2[ 3 ];
	register unsigned int in10 = gd_input_chunk2[ 4 ];
	register unsigned int in11 = gd_input_chunk2[ 5 ];
...
void HL49B06N()
{
	...
	register unsigned int in10 = gd_input_chunk2[ 4 ];
	register unsigned int in11 = gd_input_chunk2[ 5 ];
	register unsigned int in12 = gd_input_chunk2[ 6 ];
...
void HL53B06N()
{
	...
	register unsigned int in11 = gd_input_chunk2[ 5 ];
	register unsigned int in12 = gd_input_chunk2[ 6 ];
	register unsigned int in13 = gd_input_chunk2[ 7 ];
